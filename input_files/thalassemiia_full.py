...
def predict(input_param:Model_input_12):
    ...
    scale1 = open('/root/Thalasemia/models_thalassemia/Model1/scaler12ts.pkl','rb')
    model1_path = open('/root/Thalasemia/models_thalassemia/Model1/lgbm12ts.sav','rb')
    scale2 =open('/root/Thalasemia/models_thalassemia/Model2/scaler12ts.pkl','rb')
    model2_path = open('/root/Thalasemia/models_thalassemia/Model2/lgbm12ts.sav','rb')
    ...
    model2_path.close()
    input=[[str['ctm_rbc'],str['ctm_hgb'],str['ctm_hct'],str['ctm_mcv'],str['ctm_mch'],str['ctm_mchc'],str['ctm_rdw'],str['ctm_sathuyetthanh'],str['ctm_ferritinehuyetthanh'],str['dd_hba1'],str['dd_hba2'],str['dd_hbf']]]
