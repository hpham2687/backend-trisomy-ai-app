...
def predict(input_param:Model_input_trisomy):
    ...
    model21=open('/root/Thalasemia/models_trisomy/trisomy21/full21ver5.sav','rb')
    m21=pickle.load(model21)
    model21.close()
    model18=open('/root/Thalasemia/models_trisomy/trisomy18/full18ver5.sav','rb')
    m18=pickle.load(model18)
    model18.close()
    model13=open('/root/Thalasemia/models_trisomy/trisomy13/full13ver5.sav','rb')
