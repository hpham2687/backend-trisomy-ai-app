...
def predict(input_param:Model_input_trisomy):
    ...
    model21=open('/root/Thalasemia/models_trisomy/trisomy21/triple21ver5.sav','rb')
    m21=pickle.load(model21)
    model21.close()
    model18=open('/root/Thalasemia/models_trisomy/trisomy18/triple18ver5.sav','rb')
    m18=pickle.load(model18)
    model18.close()
    model13=open('/root/Thalasemia/models_trisomy/trisomy13/triple13ver5.sav','rb')
